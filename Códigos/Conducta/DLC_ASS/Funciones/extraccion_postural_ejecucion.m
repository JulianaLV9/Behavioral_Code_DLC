...
function [mean_esqueleto_x, mean_esqueleto_y] = extraccion_postural_ejecucion(matrix,umbral_barra,umbral_bebedero)
...
%%Aquí hay que utilizar el umbral de la barra para sacar todas las posturas
%%qu eno estan en la matriz.

% umbrales barra
% umbrales bebedero 
umbral_bajo = umbral_bebedero(1,1) - 110; %Esto puede modificar dependiendo de donde quede la mano
umbral_alto = umbral_bebedero(1,1); %Esto puede modificar dependiendo de donde quede la mano
indices_in  = muneca_x > umbral_bajo & muneca_x < umbral_alto; % Condición para obtener los valores dentro de los umbrales (bebedero y un espacio de 150 px)
