...
function [mean_esqueleto_x, mean_esqueleto_y] = extraccion_postural(matrix,umbral_barra,umbral_bebedero)
...
umbral_bajo = umbral_barra(1,1) - 100; %Nos desplazamos -50px donde probablemente podría estar la mano
umbral_alto = umbral_barra(1,1) + 10; %Nos desplazamos -50px donde probablemente podría estar la mano
